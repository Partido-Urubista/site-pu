			...
			<section className="flex flex-col gap-4 rounded-[0px]">
				...
				<FormProvider {...form}>
					...
					>
										...
										<div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
											<Label className="flex items-center gap-2 text-white text-sm sm:text-base p-2 hover:bg-white/10 rounded cursor-pointer">
												<Checkbox
													...
													onCheckedChange={() => field.onChange("Pouco ativo")}
												/>
												Pouco ativo
											</Label>
											<Label className="flex items-center gap-2 text-white text-sm sm:text-base p-2 hover:bg-white/10 rounded cursor-pointer">
										...
										<div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
											...
											<Label className="flex items-center gap-2 text-white text-sm sm:text-base p-2 hover:bg-white/10 rounded cursor-pointer">
												<Checkbox
													...
													onCheckedChange={() => field.onChange("Doutrinador")}
												/>
												Doutrinador
											</Label>
										</div>
						...
						/>
						<Button
							className="my-4 sm:my-6 md:my-8 duration-500 transition-all border hover:border-black h-10 sm:h-12 md:h-14 bg-black hover:bg-white hover:text-black w-full sm:w-auto sm:px-8 md:px-12"
							type="submit"
						>
